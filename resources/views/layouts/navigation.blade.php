    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('inventory.status')" :active="request()->routeIs('inventory.status')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 mr-2"><path d="M21.5 12H16c-.7 2-2 3-4 3s-3.3-1-4-3H2.5"/><path d="M5.5 5.1L2 12v6c0 1.1.9 2 2 2h16a2 2 0 002-2v-6l-3.4-6.9A2 2 0 0016.8 4H7.2a2 2 0 00-1.8 1.1z"/></svg>                         
                        {{ __('Inventory') }}
                    </x-nav-link>    
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Theme Switcher -->
                <div x-data="themeSwitcher()" x-init="initTheme()" class="flex items-center space-x-4">
                    <button @click="toggleTheme('light')" x-show="theme === 'dark'">
                        🌞
                    </button>
                
                    <button @click="toggleTheme('dark')" x-show="theme === 'light'">
                        🌙
                    </button>
                </div>
                <script>
